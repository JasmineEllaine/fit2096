...
#ifdef LAB_PROJECT_StationaryRotatingActor_generated_h
#error "StationaryRotatingActor.generated.h already included, missing '#pragma once' in StationaryRotatingActor.h"
#endif
...
public: \
	DECLARE_CLASS(AStationaryRotatingActor, AActor, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/lab_project"), NO_API) \
...
#define lab_project_Source_lab_project_StationaryRotatingActor_h_12_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, AStationaryRotatingActor); \
DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(AStationaryRotatingActor); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API AStationaryRotatingActor(AStationaryRotatingActor&&); \
	NO_API AStationaryRotatingActor(const AStationaryRotatingActor&); \
public:
...
template<> LAB_PROJECT_API UClass* StaticClass<class AStationaryRotatingActor>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID lab_project_Source_lab_project_StationaryRotatingActor_h
