#undef LAB_PROJECT_API
#undef LAB_PROJECT_VTABLE
...
#define UE_PROJECT_NAME lab_project
...
#define LAB_PROJECT_VTABLE DLLEXPORT_VTABLE
#define LAB_PROJECT_API DLLEXPORT
